...
public class SingleStatementDeclLabel extends Statement {

    private Label Label;
    private SingleStatement SingleStatement;

    public SingleStatementDeclLabel (Label Label, SingleStatement SingleStatement) {
        this.Label=Label;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleStatementDeclLabel(\n");
